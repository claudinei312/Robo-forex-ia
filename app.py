!pip install pandas ta twelvedata requests
# =========================
# IMPORTS
# =========================
import pandas as pd
...
# CONFIG
# =========================
API_KEY = "a673ea91273848e58d1507bfb031bc95"
td = TDClient(API_KEY)
...
for ativo in ativos:
    ...
    w, l, total, wr = backtest_simples(df)
...
"""
    ...
    print(mensagem)
    enviar_email("🚨 SINAL DO ROBÔ", mensagem)
